...
class FormInput extends Component<{}, FormInputState> {
  ...
  //         });
  //         console.log(data);
  //         this.navigate("/details", { state: this.state.asteroidDetails });
  //       } catch (error) {
  //         console.error("Error fetching asteroid data:", error);
  //         alert("Error fetching asteroid data! Please recheck the input ID");
  //       } finally {
  ...
  render() {
    ...
    return (
      <div className="flex flex-col justify-center items-center h-[100vh] bg-green-200 text-white pt-24 overflow-y-hidden w-screen">
