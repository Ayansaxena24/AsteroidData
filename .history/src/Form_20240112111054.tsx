...
class FormInput extends Component<RouteComponentProps, FormInputState> {
    ...
    if (!loading) {
      if (str === "id") {
        try {
          ...
          console.log(data);
          history.push("/details", { state: data });
        } catch (error) {
        ...
        try {
          ...
          console.log(data);
          history.push("/details", { state: this.state.asteroidDetails });
        } catch (error) {
          console.error("Error fetching asteroid data:", error);
          alert("Error fetching asteroid data! Please recheck the input ID");
        } finally {
