...
describe("FormInput", () => {
  ...
  it('handles successful API fetch with in Input ID', async () => {
    ...
    const mockFetch = jest.fn().mockResolvedValueOnce(mockApiResponse);
    const mockNavigation { navigate: jest.fn()};
    const mockAlert = <jest className="spyOn"></jest>
    global.fetch = mockFetch;
    ...
    wrapper.update();
    expect(wrapper.find("data")).toContain("719 Albert (A911 TB)");
