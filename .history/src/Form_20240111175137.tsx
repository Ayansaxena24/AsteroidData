...
const FormInput: React.FC = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-[100vh] bg-black text-white pt-24 overflow-hidden w-screen">
      <div className="z-10 top-6 absolute">
        <p className="font-bold text-4xl ">AsteroidOpedia</p>
      </div>
      <img src={bg} alt="bg" className="z-0 absolute top-0 right-0 h-screen w-screen" />
          ...
          >
            ...
            <div className="flex justify-center items-center w-full pt-4 z-10">
              <button
                ...
                className={`${id.length === 7 ? "border-2 border-white rounded-md px-2 duration-300 ease-in-out hover:scale-110" : "border-2 border-gray-400 rounded-md px-2 cursor-not-allowed text-gray-300"}`}
                type="submit"
              >
                Submit
              </button>
