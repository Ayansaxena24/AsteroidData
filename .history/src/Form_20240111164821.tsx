          ...
          >
            ...
            <div className="flex justify-center items-center w-full pt-4 z-10">
              <button
                ...
                className={`${id.length === 7 ? "border-2 border-white rounded-md-2 duration-300 ease-in-out hover:scale-110" : "border-2 border-gray-400 rounded-md px-2 cursor-not-allowed"}`}
                type="submit"
              >
                Submit
              </button>
