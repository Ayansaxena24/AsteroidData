...
describe("FormInput", () => {
  ...
  it("gives error when a wrong 7 digit ID is entered", () => {
    const wrapper = mount(
      <BrowserRouter>
        <FormInput navigate={() => {}} />
      </BrowserRouter>
    ...
    wrapper.update();
    const submitbutton = wrapper.find("#randombutton");
    submitbutton.simulate("click");
    wrapper.update();
    expect(wrapper.find("alert").text()).toEqual("Error fetching asteroid data! Please recheck the input ID");
  });
