...
class FormInput extends Component<{navigate:(str : string) => void, any : any}, FormInputState> {
    ...
    if (!loading) {
      ...
      if (str === "id") {
        try {
          ...
          // console.log(this);
          this.props.navigate("/details", data);
          // window.location.href = `/details`;
          // this.props.history.push("/details", { state: data });
