...
describe("FormInput", () => {
  ...
  it("handles successful API fetch with in Input ID", async () => {
    ...
    // await act (async () => {
    //   await instance.setState({ id: "2000719" });
    // });
    ...
    const actualMockApiResponse = navigateCall[1]; // Assuming the mockApiResponse is the second argument
    
    // Now, check the relevant parts of the actualMockApiResponse
    expect(actualMockApiResponse.links.self).toBe(mockApiResponse.links.self);
