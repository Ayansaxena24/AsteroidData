...
class FormInput extends Component<{navigate:(str : string, any : any) => void}, FormInputState> {
  ...
  render() {
    ...
    return (
      <div className="flex flex-col bg-cover justify-center items-center text-white pt-24 overflow-clip bg-center w-full h-auto bg-center-bottom bg-no-repeat bg-cover">
