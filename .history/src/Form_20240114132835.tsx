...
class FormInput extends Component<{navigate:(str : string, any : any) => void}, FormInputState> {
  ...
  render() {
    ...
    return (
      <div className="flex flex-col bg-cover justify-center items-center h-[100vh] text-white pt-24 overflow-clip bg-center">
        <div className="z-10 top-6 absolute">
          <p className="font-bold text-4xl ">AsteroidOpedia</p>
        </div>
        <img src={bg} alt="bg" className="z-0 absolute top-0 right-0 w-full max-h-fit bg-center-bottom bg-no-repeat bg-cover" />
